...
function leaderBoardTable(users){
  ...
  if (document.getElementById('headers-lb')== null){
    document.getElementById("my-leaderboard").innerHTML = "Leaderboard";
    $(table).append(`
      <tr id = "headers-lb">
        <th>Rank</th>
        <th>Name</th>
...
function gameTable(game_data){
  ...
  if (document.getElementById('headers')== null){
    document.getElementById("my-games").innerHTML = "My Games";
    $(table).append(`
      <tr id = "headers">
        <th>Category</th>
        <th>Difficulty</th>
...
function displayQuestions(){
  ...
  if (triviaQuestions[0].length != 0){
    document.getElementById('number-correct').innerHTML = `Correct: ${amountCorrect}`;
    ...
    document.getElementById('amount-correct').innerHTML = amountCorrect
    saveGamePlayed();
    endGame()
  }
    questionNumber += 1
...
function checkbox(id){
	if(id == "password-confirmation-register"){
		var x = document.getElementById('password-confirmation-register');
		var y = document.getElementById('password-register');
